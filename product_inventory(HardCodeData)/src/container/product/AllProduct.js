...
import broadCastDeleteProduct from '../../action/deleteproductAction'
class AllProduct extends React.Component {
    ...
    getAllProducts() {
        ...
        this.setState({ productList: this.props.allProducts, permanentproductList: this.props.allProducts })
        // }, error => {
        //     console.error(error)
        // })
    }
...
const productDispath = (dispatch) => bindActionCreators({ getProducts: getProductBroadCast, deleteProduct: broadCastDeleteProduct }, dispatch)
export default connect(productStoreToProps, productDispath)(withRouter(AllProduct));