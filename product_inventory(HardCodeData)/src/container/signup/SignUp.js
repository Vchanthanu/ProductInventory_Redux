...
import addUserBroad from '../../action/addUserAction'
...
class SignUp extends React.Component {
    ...
    signUp = (event) => {
        ...
        //         console.error(error)
        //     })
        this.props.addUser(signupRequestBody)
        this.props.history.push('/')
    }
    getFirstName = (event) => {
    ...
    vaildsubmit = () => {
        ...
        if (this.state.invalidfirstname || this.state.invalidlastname || this.state.invalidemail || this.state.invalidpassword || this.state.invalidconfirmpassword || this.state.invalidsecurityquestion || this.state.invalidanswer ) {
...
function userDispatch(dispatch) {
    return (bindActionCreators({ addUser: addUserBroad }, dispatch))
}
export default connect(null, userDispatch)(SignUp)